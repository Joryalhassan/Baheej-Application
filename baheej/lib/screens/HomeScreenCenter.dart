...
void updateService(Service updatedService) {
  final index = services.indexWhere((service) => service.id == updatedService.id);
  if (index != -1) {
    setState(() {
                              ...
                              children: [
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      '${service.servicePrice.toStringAsFixed(1)}',
                                      style: TextStyle(
                                        fontSize: 16,
                                      ),
                                    ),
                                      ...
                                      onTap: () {
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                            builder: (context) =>
                                                EditService(
                                              service: service,onUpdateService: updateService,
                                            ),
                                          ),
                                        );
                                      },
